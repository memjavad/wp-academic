...
function get_option($option, $default = false) { global $mock_get_option; return isset($mock_get_option[$option]) ? $mock_get_option[$option] : $default; }
...
// Mocks for test_author_subtitle
$mock_get_option = [];
...
if (!function_exists('is_single')) {
    function is_single() {
        ...
        return $mock_is_single;
    }
}

if (!function_exists('in_the_loop')) {
    function in_the_loop() {
        global $mock_in_the_loop;
        return $mock_in_the_loop;
    }
}

if (!function_exists('is_main_query')) {
    function is_main_query() {
        global $mock_is_main_query;
        return $mock_is_main_query;
    }
}

if (!function_exists('get_the_ID')) {
    function get_the_ID() {
        global $mock_get_the_ID;
        return $mock_get_the_ID;
    }
}
