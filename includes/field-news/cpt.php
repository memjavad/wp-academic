...
function wpa_field_news_register_cpt() {
    ...
    // Flush rules once to fix 404s when the custom post type is created.
    // This uses an option to avoid flushing on every init, which is a standard WordPress pattern for performance.
