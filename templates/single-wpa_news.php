                        ...
                        ?>
                            <div class="wpa-sidebar-card wpa-share-card">
                                ...
                                <div class="wpa-share-buttons">
                                                                <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode($title); ?>&url=<?php echo urlencode($url); ?>" target="_blank" rel="noopener noreferrer" class="wpa-btn-icon wpa-btn-twitter" aria-label="<?php esc_attr_e( 'Share on X (Twitter)', 'wp-academic-post-enhanced' ); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
                                                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($url); ?>" target="_blank" rel="noopener noreferrer" class="wpa-btn-icon wpa-btn-facebook" aria-label="<?php esc_attr_e( 'Share on Facebook', 'wp-academic-post-enhanced' ); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/></svg></a>
                                                                <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode($url); ?>" target="_blank" rel="noopener noreferrer" class="wpa-btn-icon wpa-btn-linkedin" aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'wp-academic-post-enhanced' ); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M6.94 5a2 2 0 1 1-4-.002 2 2 0 0 1 4 .002zM7 8.48H3V21h4V8.48zm6.32 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91l.04-1.68z"/></svg></a>
                                                                <a href="https://wa.me/?text=<?php echo urlencode($title . ' ' . $url); ?>" target="_blank" rel="noopener noreferrer" class="wpa-btn-icon wpa-btn-whatsapp" aria-label="<?php esc_attr_e( 'Share on WhatsApp', 'wp-academic-post-enhanced' ); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.711 2.598 2.664-.698c.976.554 2.058.947 2.796.947 3.181 0 5.768-2.587 5.768-5.766-.001-3.181-2.587-5.768-5.768-5.766zm.002-4.172c5.488 0 9.949 4.462 9.949 9.948 0 1.745-.458 3.492-1.332 5.038l1.38 5.014-5.265-1.38c-1.487.817-3.153 1.276-4.732 1.276-5.488 0-9.949-4.461-9.949-9.948 0-5.486 4.461-9.948 9.949-9.948z"/></svg></a>                                </div>
                            </div>
                        <?php endif; ?>
